...
namespace DAL
{
    public class AccesoDatos
    {
        ...
        SqlConnection conexion = new SqlConnection(@"Data Source=LAPTOP-RJIKNK5J\SQLEXPRESS01;Initial Catalog=Libreria;Integrated Security=True");
        ...
        public DataTable LeerDT(string consulta)
        {
